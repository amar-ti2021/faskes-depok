  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Faskes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">Edit Data <?= $faskes->nama; ?></h3>
          ...
          <input type="hidden" name="old_foto1" value="<?= $faskes->foto1; ?>">
          <input type="hidden" name="old_foto2" value="<?= $faskes->foto2; ?>">
          <input type="hidden" name="old_foto3" value="<?= $faskes->foto3; ?>">
          <div class="card-body">
            <div class="form-group row">
              <label for="nama" class="col-sm-2 col-form-label">Nama</label>
              <div class="col-sm-10">
                <input type="text" name="nama" value="<?= $faskes->nama; ?>" class="form-control" id="nama" placeholder="nama">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <select name="kecamatan" class="custom-select">
                  <?php foreach ($kecamatan as $k) { ?>
                    <option value="<?= $k->id; ?>" <?= ($k->id == $faskes->kecamatan_id) ? 'selected' : ''; ?>><?= $k->nama; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="alamat" id="alamat" rows="3"><?= $faskes->alamat; ?></textarea>
              </div>
            </div>
            <div class="form-group row">
              <label for="latlong" class="col-sm-2 col-form-label">Koordinat</label>
              <div class="col-sm-10">
                <input type="text" name="latlong" value="<?= $faskes->latlong; ?>" class="form-control" id="latlong" placeholder="Koordinat">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <select name="jenis" class="custom-select">
                  <?php foreach ($jenis_faskes as $j) { ?>
                    <option value="<?= $j->id; ?>" <?= ($j->id == $faskes->jenis_id) ? 'selected' : ''; ?>><?= $j->nama; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="deskripsi" id="alamat" rows="3"><?= $faskes->deskripsi; ?></textarea>
              </div>
            </div>
            <div class="form-group row">
              <label for="website" class="col-sm-2 col-form-label">Website</label>
              <div class="col-sm-10">
                <input type="text" name="website" value="<?= $faskes->website; ?>" class="form-control" id="website" placeholder="Website">
              </div>
            </div>
            <div class="form-group row">
              <label for="jumlah_dokter" class="col-sm-2 col-form-label">Jumlah Dokter</label>
              <div class="col-sm-10">
                <input type="number" name="jumlah_dokter" value="<?= $faskes->jumlah_dokter; ?>" class="form-control" id="jumlah_dokter" min="1" value="1">
              </div>
            </div>
            <div class="form-group row">
              <label for="jumlah_pegawai" class="col-sm-2 col-form-label">Jumlah Pegawai</label>
              <div class="col-sm-10">
                <input type="number" name="jumlah_pegawai" value="<?= $faskes->jumlah_pegawai; ?>" class=" form-control" id="jumlah_pegawai" min="1" value="1">
              </div>
            </div>
            <div class="form-group row">
